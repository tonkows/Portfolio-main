        ...
        <div className="about__data grid">
          <div className="about__info">
            <p className="about__description">
              Hello, my name is Kanittha Somboon, and I'm Motivated Computer Science graduate from Kasetsart University with hands-on experience in system analysis, web development, and UX/UI design. 
